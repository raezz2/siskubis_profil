                                                ...
                                                <div class="card mb-2">
                                                    <div class="card-body">
                                                        <div class="form-group row">
                                                            <label class="col-sm-2 col-form-label" for="id_team">ID</label>
                                                            <div class="col-sm-10">
                                                                <input class="form-control" id="id_team" name="id_team[]" type="text" placeholder="Digital marketing..." value="{{ $team->id }}">
                                                            </div>
                                                        </div>
                                                        <div class="form-group row">
