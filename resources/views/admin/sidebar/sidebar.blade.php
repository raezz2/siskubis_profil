                ...
                <div class="side-nav">
                    <div class="main-menu">
                        <ul class="metismenu" id="menu">
                            <li class="Ul_li--hover"><a class="active" href="{{route('admin.home')}}"><i class="i-Bar-Chart text-20 mr-2 text-muted"></i><span class="item-name text-15 text-muted">Dashboard</span></a>
                                
                            </li>
                            <li class="Ul_li--hover"><a class="" href="{{route('admin.inkubator')}}"><i class="i-Loading-3 text-20 mr-2 text-muted"></i><span class="item-name text-15 text-muted">Inkubator</span></a></li> 

							<li class="Ul_li--hover"><a class="" href="{{route('admin.tenant')}}"><i class="i-Administrator text-20 mr-2 text-muted"></i><span class="item-name text-15 text-muted">Tenant</span></a></li>
