...
<div class="breadcrumb">
	<h1 class="mr-2">Tenant Scale Up</h1>
	<button class="btn btn-primary btn-sm m-1 float-right" type="button">Primary</button>
</div>
		...
		<div class="col-12">
			<div class="card">
				<div class="card-body">
					<div class="row">
						<div class="col-lg-6">
							<div class="ul-product-detail__image"><img src="{{ asset('theme/images/mac_book.jpg')}}" alt="alt" /></div>
						</div>
						<div class="col-lg-6">
				...
				<div class="card-body">
					...
					<div class="tab-content ul-tab__content p-5" id="nav-tabContent">
						<div class="tab-pane fade active show" id="nav-home" role="tabpanel" aria-labelledby="nav-home-tab">
							<div class="row">
								<div class="col-lg-4 col-md-4 col-sm-12"><img src="{{ asset('theme/images/mac_book.jpg')}}" alt="alt" /></div>
						...
						<div class="tab-pane fade" id="nav-brand" role="tabpanel" aria-labelledby="nav-contact-tab">
							<div class="row">
								<div class="col-lg-2"><img src="{{ asset('theme/images/mac_book.jpg')}}" alt="alt" /></div>
