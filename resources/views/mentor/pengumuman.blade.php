        ...
        <div class="card">
            ...
            <div class="card-body">
                <div class="ul-contact-list">
                    ...
                    <br>
                    <div class="list-group" id="list-tab" role="tablist"><a class="list-group-item list-group-item-action border-0 {{ set_active('mentor.pengumuman')}}" id="list-home-list" href="{{ route('mentor.pengumuman')}}" role="tab" aria-controls="home"><i class="nav-icon i-Business-Mens"></i> Semua Pengumuman</a>
                        <a class="list-group-item list-group-item-action border-0 {{ set_active('mentor.non-tenant')}}" id="list-profile-list " href="{{ route('mentor.non-tenant')}}" role="tab" aria-controls="profile"><i class="nav-icon i-Conference"></i> Non Tenan</a>
