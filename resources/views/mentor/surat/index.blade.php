					...
					<table class="display table" id="masuk" style="width:100%">
						...
						@foreach($surat as $s)
							...
							<tr>
								...
								@endif
								<td>{{ $s->created_at }}</td>
								<td><a class="ul-link-action text-success" href="/mentor/surat/edit/{{ $s->id }}" data-toggle="tooltip" data-placement="top" title="Edit"><i class="i-Edit"></i></a><a class="ul-link-action text-danger mr-1 delete"  data-toggle="tooltip" data-placement="top" disposisi-id="{{ $s->id }}" title="Want To Delete !!!"><i class="i-Eraser-2" ></i></a></td>
							</tr>
