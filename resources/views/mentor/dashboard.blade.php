...
<div class="breadcrumb">
	<h1 class="mr-2">Dashboard Mentor</h1>
	<ul>
		<li><a href="">Dashboard</a></li>
		<li>Summary Inkubator</li>
	</ul>
</div>
                ...
                <div class="row mb-4">
                        ...
                        <div class="card mb-4 o-hidden">
                            <div class="card-body ul-card__widget-chart">
                                <div class="ul-widget__chart-info">
                                    <h5 class="heading">ANGGARAN 2020</h5>
                                    <div class="ul-widget__chart-number">
                                        <h2 class="t-font-boldest">Rp 1.000.000.000,- </h2><small class="text-muted">12% compared to last year</small>
                                    </div>
                                </div>
                    ...
                    <div class="col-md-3 col-lg-3">
                        <div class="card mb-4 o-hidden">
                            <div class="card-body ul-card__widget-chart">
                                <div class="ul-widget__chart-info">
                                    <h5 class="heading">PRODUKSI 2020</h5>
                                    <div class="ul-widget__chart-number">
                                        <h2 class="t-font-boldest">Rp 898.000.000,- </h2><small class="text-muted">8% compared to last year</small>
                                    </div>
                                </div>
                    ...
                    <div class="col-md-3 col-lg-3">
                        <div class="card mb-4 o-hidden">
                            <div class="card-body ul-card__widget-chart">
                                <div class="ul-widget__chart-info">
                                    <h5 class="heading">OMSET 2020</h5>
                                    <div class="ul-widget__chart-number">
                                        <h2 class="t-font-boldest">Rp 6.909.000.000,- </h2><small class="text-muted">45% compared to last year</small>
                                    </div>
                                </div>
                    ...
                    <div class="col-md-3 col-lg-3">
                        <div class="card mb-4 o-hidden">
                            <div class="card-body ul-card__widget-chart">
                                <div class="ul-widget__chart-info">
                                    <h5 class="heading">PROFIT 2020</h5>
                                    <div class="ul-widget__chart-number">
                                        <h2 class="t-font-boldest">Rp 5.000.000.000,-</h2><small class="text-muted">35% compared to last year</small>
                                    </div>
                                </div>
                    ...
                    <div class="col-md-12 col-lg-8 mt-4">
                        <div class="card o-hidden h-100">
                                ...
                                <div class="row" style="align-items: center;">
                                    <div class="col-md-6">
                                        <div class="ul-card-widget__head-label">
                                            <h5 class="text-18 font-weight-700 card-title">Proyeksi Keuangan</h5>
                                        </div>
                                    </div>
                            ...
                            <div class="card-body">
                                <div class="row">
                                    <div class="col-md-6">
                                        <h3 class="text-muted text-14 font-weight-500">Total Perputaran Keuangan 2019-2020</h3><span class="text-muted text-18 font-weight-600">Rp 15.420.000.000,-</span>
                                    </div>
                                    <div class="col-md-6">
                                        <h3 class="text-muted text-14 font-weight-500">Proyeksi Keuangan hingga</h3><span class="text-muted text-18 font-weight-600">Juni 2020</span>
                                    </div>
                                </div>
                            </div>
                            <div>
                                    ...
                                    <div class="ul-widget-s7">
                                        <div class="ul-widget-s7__items"><span class="ul-widget-s7__item-time">10:00</span>
                                            ...
                                            <div class="ul-widget-s7__item-text">
                                               PT. Nusa Indah Prataman
                                               <br /> Mengupload dokumen HAKI
                                            </div>
                                        </div>
                                    </div>
                                    <div class="ul-widget-s7">
                                        <div class="ul-widget-s7__items"><span class="ul-widget-s7__item-time">16:00 </span>
                                            ...
                                            <div class="ul-widget-s7__item-text">
                                                PT. Risba mitra karya
                                                <br /> Melaporkan Keuangan
                                            </div>
                                        </div>
                                    </div>
                            ...
                            <div class="card-body">
                                <div class="ul-widget__head v-margin">
                                    <div class="ul-widget__head-label">
                                        <h3 class="ul-widget__head-title">Produk Tenan</h3>
                                    </div>
                                            ...
                                            <table class="table">
                                                ...
                                                <tbody>
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td><span>
                                                                <div class="ul-widget_user-card">
                                                                    <div class="ul-widget4__img"><img id="userDropdown" src="{{ asset('theme/images/faces/1.jpg')}}" alt="" /></div>
                                                                </div>
                                                            </span></td>
                                                        <td>11/28/2016</td>
                                                        <td><span class="badge badge-pill badge-outline-danger p-2 m-1">Verifikasi</span></td>
                                                        <td><a class="ul-widget4__title d-block" href="">UI Lib</a></td>
                                                        <td>
                                                            <button class="btn bg-white _r_btn border-0" type="button" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false"><span class="_dot _inline-dot bg-primary"></span><span class="_dot _inline-dot bg-primary"></span><span class="_dot _inline-dot bg-primary"></span></button>
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td><span>
                                                                <div class="ul-widget_user-card">
                                                                    <div class="ul-widget4__img"><img id="userDropdown" src="{{ asset('theme/images/faces/10.jpg')}}" alt="" /></div>
                                                                </div>
                                                            </span></td>
                                                        <td>11/28/2016</td>
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td><span>
                                                                <div class="ul-widget_user-card">
                                                                    <div class="ul-widget4__img"><img id="userDropdown" src="{{ asset('theme/images/faces/12.jpg')}}" alt="" /></div>
                                                                </div>
                                                            </span></td>
                                                        <td>11/28/2016</td>
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td><span>
                                                                <div class="ul-widget_user-card">
                                                                    <div class="ul-widget4__img"><img id="userDropdown" src="{{ asset('theme/images/faces/13.jpg')}}" alt="" /></div>
                                                                </div>
                                                            </span></td>
                                                        <td>11/28/2016</td>
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td><span>
                                                                <div class="ul-widget_user-card">
                                                                    <div class="ul-widget4__img"><img id="userDropdown" src="{{ asset('theme/images/faces/15.jpg')}}" alt="" /></div>
                                                                </div>
                                                            </span></td>
                                                        <td>11/28/2016</td>
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td><span>
                                                                <div class="ul-widget_user-card">
                                                                    <div class="ul-widget4__img"><img id="userDropdown" src="{{ asset('theme/images/faces/16.jpg')}}" alt="" /></div>
                                                                </div>
                                                            </span></td>
                                                        <td>11/28/2016</td>
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td><span>
                                                                <div class="ul-widget_user-card">
                                                                    <div class="ul-widget4__img"><img id="userDropdown" src="{{ asset('theme/images/faces/17.jpg')}}" alt="" /></div>
                                                                </div>
                                                            </span></td>
                                                        <td>11/28/2016</td>
                                                        <td><span class="badge badge-pill badge-outline-success p-2 m-1">Processing</span></td>
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td><span>
                                                                <div class="ul-widget_user-card">
                                                                    <div class="ul-widget4__img"><img id="userDropdown" src="{{ asset('theme/images/faces/2.jpg')}}" alt="" /></div>
                                                                </div>
                                                            </span></td>
                                                        <td>11/28/2016</td>
                                                        <td><span class="badge badge-pill badge-outline-info p-2 m-1">Processing</span></td>
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td><span>
                                                                <div class="ul-widget_user-card">
                                                                    <div class="ul-widget4__img"><img id="userDropdown" src="{{ asset('theme/images/faces/3.jpg')}}" alt="" /></div>
                                                                </div>
                                                            </span></td>
                                                        <td>11/28/2016</td>
                                                        <td><span class="badge badge-pill badge-outline-warning p-2 m-1">Processing</span></td>
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td><span>
                                                                <div class="ul-widget_user-card">
                                                                    <div class="ul-widget4__img"><img id="userDropdown" src="{{ asset('theme/images/faces/4.jpg')}}" alt="" /></div>
                                                                </div>
                                                            </span></td>
                                                        <td>11/28/2016</td>
                                                        <td><span class="badge badge-pill badge-outline-success p-2 m-1">Processing</span></td>
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td><span>
                                                                <div class="ul-widget_user-card">
                                                                    <div class="ul-widget4__img"><img id="userDropdown" src="{{ asset('theme/images/faces/5.jpg')}}" alt="" /></div>
                                                                </div>
                                                            </span></td>
                                                        <td>11/28/2016</td>
                                                        <td><span class="badge badge-pill badge-outline-info p-2 m-1">Processing</span></td>
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td><span>
                                                                <div class="ul-widget_user-card">
                                                                    <div class="ul-widget4__img"><img id="userDropdown" src="{{ asset('theme/images/faces/9.jpg')}}" alt="" /></div>
                                                                </div>
                                                            </span></td>
                                                        <td>11/28/2016</td>
                                                        <td><span class="badge badge-pill badge-outline-danger p-2 m-1">Processing</span></td>
                        ...
                        <div class="card h-100">
                            <div class="card-body">
                                <div class="ul-widget__head">
                                    <div class="ul-widget__head-label">
                                        <h3 class="ul-widget__head-title">Tenan Baru</h3>
                                    </div>
                                    ...
                                    <div class="tab-content">
                                        <div class="tab-pane active show" id="__g-widget4-tab1-content">
                                            <div class="ul-widget1">
                                                <div class="ul-widget4__item ul-widget4__users">
                                                    <div class="ul-widget4__img"><img id="userDropdown" src="{{ asset('theme/images/faces/1.jpg')}}" alt="" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false" /></div>
                                                    <div class="ul-widget2__info ul-widget4__users-info"><a class="ul-widget2__title" href="#">Ui Libs</a><span class="ul-widget2__username" href="#">Aplikasi Penghitung kendaraan</span></div>
                                                    <div class="ul-widget4__actions">
                                                        <button class="btn btn-outline-danger m-1" type="button">Lihat</button>
                                                    </div>
                                                </div>
                                                <div class="ul-widget4__item ul-widget4__users">
                                                    <div class="ul-widget4__img"><img id="userDropdown" src="{{ asset('theme/images/faces/2.jpg')}}" alt="" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false" /></div>
                                                ...
                                                <div class="ul-widget4__item ul-widget4__users">
                                                    <div class="ul-widget4__img"><img id="userDropdown" src="{{ asset('theme/images/faces/3.jpg')}}" alt="" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false" /></div>
                                                    <div class="ul-widget2__info ul-widget4__users-info"><a class="ul-widget2__title" href="#">Anna Strong</a><span class="ul-widget2__username" href="#">Visual Designer,Google Inc</span></div>
                                                    <div class="ul-widget4__actions">
                                                ...
                                                <div class="ul-widget4__item ul-widget4__users">
                                                    <div class="ul-widget4__img"><img id="userDropdown" src="{{ asset('theme/images/faces/5.jpg')}}" alt="" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false" /></div>
                                                    <div class="ul-widget2__info ul-widget4__users-info"><a class="ul-widget2__title" href="#">Anna Strong</a><span class="ul-widget2__username" href="#">Visual Designer,Google Inc</span></div>
                                                    <div class="ul-widget4__actions">
                                        ...
                                        <div class="tab-pane" id="__g-widget4-tab2-content">
                                            <div class="ul-widget1">
                                                ...
                                                <div class="ul-widget4__item ul-widget4__users">
                                                    <div class="ul-widget4__img"><img id="userDropdown" src="{{ asset('theme/images/faces/4.jpg')}}" alt="" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false" /></div>
                                                    <div class="ul-widget2__info ul-widget4__users-info"><a class="ul-widget2__title" href="#">Anna Strong</a><span class="ul-widget2__username" href="#">Visual Designer,Google Inc</span></div>
                                                    <div class="ul-widget4__actions">
                                                        <button class="btn btn-outline-info m-1" type="button">Follow</button>
                                                    </div>
                                    ...
                                    <table class="table table-bordered text-center">
                                        ...
                                        <tbody>
                                            <tr>
                                                <th scope="row">1</th>
                                                <td>Smith Doe</td>
                                                <td><img class="rounded-circle m-0 avatar-sm-table" src="{{ asset('theme/images/faces/1.jpg')}}" alt="" /></td>
