			...
			<div class="container">
				...
				<div id="menu-list">
					<ul class="nav-list">
						...
						<li class="dropdown magz-dropdown magz-dropdown-megamenu"><a href="#">Start Up <i class="ion-ios-arrow-right"></i>
								<div class="badge">Hot</div>
							</a>
							<div class="dropdown-menu megamenu">
								<div class="megamenu-inner">
						...
						<li class="dropdown magz-dropdown magz-dropdown-megamenu"><a href="#">Scale Up <i class="ion-ios-arrow-right"></i>
								<div class="badge">Hot</div>
							</a>
							<div class="dropdown-menu megamenu">
								<div class="megamenu-inner">
