	...
	<div class="card text-left">
		<div class="card-body">
			...
			<h3 class="" style="margin: 0 20px 0px 0px;padding: 5px;">Surat Keluar</h3>
				...
				<a href="{{ url('/mentor/buatsuratkeluar')}}"><li  class="btn btn-danger btn-sm mt-2" width="10%" >Buat Surat</li></a>
					...
					<table class="display table" id="masuk" style="width:100%">
						...
						@foreach($surat as $s)
							<tr>
								...
								@endif
								<td>{{ $s->created_at }}</td>
								<td><a class="ul-link-action text-success" href="{{ url('/mentor/surat/edit/'. $s->id) }}" data-toggle="tooltip" data-placement="top" title="Edit"><i class="i-Edit"></i></a><a class="ul-link-action text-danger mr-1 delete"  data-toggle="tooltip" data-placement="top" surat-id="{{ $s->id }}" title="Want To Delete !!!"><i class="i-Eraser-2" ></i></a></td>
							</tr>
						@endforeach
						</tbody>
					</table>
