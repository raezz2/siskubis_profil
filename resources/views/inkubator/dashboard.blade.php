	...
	<div class="col-lg-6 col-md-12">
		<div class="card mb-4">
			<div class="card-body">
				...
				<div class="d-flex flex-column flex-sm-row align-items-sm-center mb-3"><img class="avatar-lg mb-3 mb-sm-0 rounded mr-sm-3" src="{{ asset('theme/images/products/headphone-4.jpg')}}" alt="" />
				...
				<div class="d-flex flex-column flex-sm-row align-items-sm-center mb-3"><img class="avatar-lg mb-3 mb-sm-0 rounded mr-sm-3" src="{{ asset('theme/images/products/headphone-2.jpg')}}" alt="" />
					<div class="flex-grow-1">
				...
				<div class="d-flex flex-column flex-sm-row align-items-sm-center mb-3"><img class="avatar-lg mb-3 mb-sm-0 rounded mr-sm-3" src="{{ asset('theme/images/products/headphone-3.jpg')}}" alt="" />
					<div class="flex-grow-1">
