...
<div class="card chat-sidebar-container" data-sidebar-container="chat">
                    <div class="chat-sidebar-wrap" data-sidebar="chat">
                        <div class="border-right">
                            ...
                            <div class="contacts-scrollable perfect-scrollbar">
                                ...
                                <div class="p-3 d-flex align-items-center border-bottom online contact"><img class="avatar-sm rounded-circle mr-3" src="{{ asset('theme/images/faces/13.jpg')}}" alt="alt" />
                                    <div>
                                ...
                                <div class="p-3 d-flex border-bottom align-items-center contact online"><img class="avatar-sm rounded-circle mr-3" src="{{ asset('theme/images/faces/3.jpg')}}" alt="alt" />
                                    <h6>PT. Indie Margo Mulyo</h6>
                                </div>
                                <div class="p-3 d-flex border-bottom align-items-center contact online"><img class="avatar-sm rounded-circle mr-3" src="{{ asset('theme/images/faces/4.jpg')}}" alt="alt" />
                                    <h6>PT. Jogja Berhati Nyaman</h6>
                                </div>
                                <div class="p-3 d-flex border-bottom align-items-center contact"><img class="avatar-sm rounded-circle mr-3" src="{{ asset('theme/images/faces/5.jpg')}}" alt="alt" />
                    ...
                    <div class="chat-content-wrap" data-sidebar-content="chat">
                        <div class="d-flex pl-3 pr-3 pt-2 pb-2 o-hidden box-shadow-1 chat-topbar"><a class="link-icon d-md-none" data-sidebar-toggle="chat"><i class="icon-regular i-Right ml-0 mr-3"></i></a>
                            <div class="d-flex align-items-center"><img class="avatar-sm rounded-circle mr-2" src="{{ asset('theme/images/faces/13.jpg')}}" alt="alt" />
                        ...
                        <div class="chat-content perfect-scrollbar" data-suppress-scroll-x="true">
                            <div class="d-flex mb-4">
                                ...
                                </div><img class="avatar-sm rounded-circle ml-3" src="{{ asset('theme/images/faces/13.jpg')}}" alt="alt" />
                            </div>
                            <div class="d-flex mb-4 user"><img class="avatar-sm rounded-circle mr-3" src="{{ asset('theme/images/faces/1.jpg')}}" alt="alt" />
                                <div class="message flex-grow-1">
                                    <div class="d-flex">
